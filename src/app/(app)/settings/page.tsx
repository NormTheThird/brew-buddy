...
export default async function SettingsPage() {
  ...
  return (
    <>
      ...
      />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 20, alignItems: "start", maxWidth: 980 }}>
        <div className="panel">
          <div className="panel-heading">Profile & theme</div>
